    ...
    >
      <v-flex mb-4>
        ...
        <transition name="custom-classes-transition" mode="out-in" enter-active-class="animated bounce" leave-active-class="animated bounceOutRight">
          ...
          <div v-else-if="nakcat_results != null" key="result">
            <p>nakcat's result</p>
            <!-- 結果サマリ -->
